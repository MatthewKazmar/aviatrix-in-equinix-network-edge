resource "aviatrix_edge_spoke" "this" {
  ...
  wan_interface_ip_prefix        = var.edge["wan_interface_ip_prefix"][count]
  wan_default_gateway_ip         = var.edge["wan_default_gateway_ip"]
  lan_interface_ip_prefix        = var.edge["lan_interface_ip_prefix"][count]
...
data "local_file" "this" {
  ...
  filename = "./${aviatrix_edge_spoke.this[count].gw_name}-${local.site_id}-cloud-init.txt"
}
